...
const LIGHT_THEMES = ['lab-light', 'solarized', 'bot-pop', 'kapow', 'dino'];
...
const LANG = {
  en: {
    ...
    working: 'Working…',
    't_lab-light': '🔬 Lab (light)', 't_lab-dark': '🔬 Lab (dark)',
    t_terminal: '💻 Terminal',       t_solarized: '💻 Solarized',
    t_robot: '🤖 Robot',             't_bot-pop': '🤖 Bot Pop',
    t_kapow: '⚡ Kapow!',            t_blastoff: '🚀 Blastoff', t_dino: '🦖 Dino',
    ready: '🚀 App ready!',
  ...
  fr: {
    ...
    working: 'En cours…',
    't_lab-light': '🔬 Labo (clair)', 't_lab-dark': '🔬 Labo (sombre)',
    t_terminal: '💻 Terminal',         t_solarized: '💻 Solarisé',
    t_robot: '🤖 Robot',               't_bot-pop': '🤖 Bot Pop',
    t_kapow: '⚡ Kapow !',             t_blastoff: '🚀 Décollage', t_dino: '🦖 Dino',
  ...
  ar: {
    ...
    working: 'جارٍ…',
    't_lab-light': '🔬 مختبر (فاتح)', 't_lab-dark': '🔬 مختبر (داكن)',
    t_terminal: '💻 تيرمينال',          t_solarized: '💻 سولارايزد',
    t_robot: '🤖 روبوت',                't_bot-pop': '🤖 بوت بوب',
    t_kapow: '⚡ كاباو!',                t_blastoff: '🚀 إنطلاق', t_dino: '🦖 ديناصور',
    ready: '🚀 التطبيق جاهز!',
...
const THEME_MELODIES = {
  'lab-light':  [523, 659, 784],    // C5 E5 G5 — bright clean
  'lab-dark':   [440, 554, 698],    // A4 C#5 F5 — mysterious mid
  'terminal':   [880, 880, 880],    // A5 ×3 — staccato CRT beep
  'solarized':  [392, 494, 587],    // G4 B4 D5 — warm classical
  'robot':      [440, 554, 659],    // A4 C#5 E5 — techy
  'bot-pop':    [523, 659, 784, 1047], // C5 E5 G5 C6 — cartoon arpeggio
  'kapow':      [659, 784, 1047, 784], // E5 G5 C6 G5 — comic-book POW
  'blastoff':   [262, 392, 523, 784, 1047], // C4→C6 — countdown lift-off
  'dino':       [196, 247, 294],    // G3 B3 D4 — deep & earthy roar
  'retro':      [523, 262, 523],    // C5 C4 C5 — Konami beep
};
...
function initPixelPet() {
  if (document.getElementById('pixelPet')) return; // idempotent — only one pet
